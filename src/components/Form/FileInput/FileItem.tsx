...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      complete: {
        container:
          'bg-green-50 border-green-300 dark:bg-green-500/10 dark:border-green-300/10',
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-error-700 dark:text-error-500 text-sm">
              Upload failed, please try again.
            </span>
            <span className="text-error-600 text-sm font-medium dark:text-zinc-400">
              {name}
            </span>
          </div>
          ...
          <button
            type="button"
            className="text-error-700 hover:text-error-900 dark:text-error-500/70 dark:hover:text-error-300 text-sm font-semibold"
          >
            Try again
          </button>
        </div>
